...
If we write the EVD as sum of outer products, scaled by corresponding eigen value then. Each EVD layer is $L_i=\lambda_iq_ir_i$, where $q_i$ is a column of $Q$ and
$r_i$ is a row of $Q^{-1}$.  Its size is
$\lVert L_i\rVert_F=|\lambda_i|\lVert q_i\rVert_2\lVert r_i\rVert_2$.
...
\toprule
$i$ & \multicolumn{1}{c}{$\lambda_i$} & $|\lambda_i|$ & $\lVert q_i\rVert$ & $\lVert r_i\rVert$ & layer size \\
\midrule
...
\textbf{18} & \textbf{115.92 + 3.91i} & \textbf{116.0} & \textbf{1.0} & \textbf{88.8} & \textbf{10297} \\
\textbf{19} & \textbf{115.92 - 3.91i} & \textbf{116.0} & \textbf{1.0} & \textbf{88.8} & \textbf{10297} \\
\midrule
20 & -26.14 + 96.61i   & 100.1   & 1.0 & 10.3 & 1027  \\
21 & -26.14 - 96.61i   & 100.1   & 1.0 & 10.3 & 1027  \\
\bottomrule
\end{tabular}
\caption{The first 20 EVD layers kept at $k=20$; indices 20 and 21 are shown only for comparison.}
\end{table}
